...
import { RawIntlProvider, createIntl, createIntlCache } from '/Users/sea/Desktop/work/sea-ui/node_modules/react-intl';
import { useIsomorphicLayoutEffect } from '/Users/sea/Desktop/work/sea-ui/node_modules/dumi/dist/client/theme-api/utils.js'
...
const LocalesContainer: FC<{ children: ReactNode }> = (props) => {
  const getIntl = useCallback(() => {
    ...
    localeMessages['$internal.edit.link'] = "https://github.com/hx-sea/sae-ui/edit/master/{filename}";

    localeMessages['$internal.api.sourceLink'] = "https://github.com/hx-sea/sae-ui/tree/master/{fileName}#L{line}";
